...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17523490.svg)](https://doi.org/10.5281/zenodo.17523490)  
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)  

---

⚠️ **Warning**: A malicious repository with the same name (`haiitexytex/cognitive-uncertainty-principle-verification`) distributes a trojan.  
**I do not provide .exe installers or binary .zip files.** Only source code and data are published here.  
...
under finite perceptual resolution.  
This instability drives the self-organization processes responsible for 
the emergence of 1/f spectral structure and Benford-like digit distributions.  
